...
function MobileCardRow({
  ...
  return (
    <div
      ref={setNodeRef}
      className={cn(
        "rounded-lg border border-border p-3 bg-card hover:bg-muted/50 cursor-pointer",
    ...
    >
      ...
      <div className="mt-2 flex items-center gap-2 flex-wrap pl-6">
        ...
        {statusConfig && (
          <Badge variant="outline" className={cn("text-xs px-1.5 py-0 h-5", statusConfig.color)}>
            {statusConfig.label}
          </Badge>
        )}
      </div>
