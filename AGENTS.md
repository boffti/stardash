...
Supabase project: **`supabase-cyan-car`** (ref: `fsapgfxqetntkzszsuch`). Use **Supabase MCP** for all DB/auth interactions — schema inspection, migrations, auth config. Never guess at schema shape.
